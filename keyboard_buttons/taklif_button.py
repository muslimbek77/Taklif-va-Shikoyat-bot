...
our_course_btn = ReplyKeyboardMarkup(
    keyboard=[
        ...
        [KeyboardButton(text="🖌️ Grafik Dizayner"), KeyboardButton(text="🎭 Shaxsiy Brend (Face brand)")],
        [KeyboardButton(text="🎥 Videografiya"),KeyboardButton(text="🎯 Target (Reklama Sozlash)") ],
